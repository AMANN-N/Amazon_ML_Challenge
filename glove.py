...
wv = pd.read_table('C:/Users/Aman/Downloads/Amazon ML Challenge/glove.6B.300d.txt', sep=" ", index_col=0, header=None, quoting=csv.QUOTE_NONE)
...
fn=['dataset']
for i in range(0,1):
    fname="C:/Users/Aman/Downloads/Amazon ML Challenge/datasetb2d9982/dataset/train.csv"
    df = pd.read_csv(fname,encoding='latin-1')
    df['TITLE'] = df['TITLE'].apply(clean_text)
    print(df.head(10))
    comtdata=df
    test_tokenized = comtdata.apply(lambda r: w2v_tokenize_text(r['TITLE']), axis=1).values
